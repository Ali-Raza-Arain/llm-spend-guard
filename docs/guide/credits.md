...
If **llm-spend-guard** saves your team from surprise LLM bills, consider supporting its development:
...
Want to contribute? Check out the [GitHub repository](https://github.com/Ali-Raza-Arain/llm-spend-guard).
